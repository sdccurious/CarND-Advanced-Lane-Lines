...
src = np.float32([(bottom_x_left, bottom_y), (bottom_x_right, bottom_y),(top_x_left, top_y), (top_x_right, top_y)])
dst = np.float32([(bottom_x_left, bottom_y), (bottom_x_right, bottom_y),(bottom_x_left, 0), (bottom_x_right, 0)])
